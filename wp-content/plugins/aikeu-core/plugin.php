...
class TP_Core_Plugin
{
	...
	public function tpcore_widget_list()
	{
		return [
			...
			['folder' => 'button', 'file' => 'submit-button'],
			['folder' => 'heading', 'file' => 'heading'],
			['folder' => 'heading-content', 'file' => 'heading-content'],
			['folder' => 'banner', 'file' => 'banner'],
			['folder' => 'text-slider', 'file' => 'text-slider'],
			['folder' => 'section-render', 'file' => 'section-render'],
			['folder' => 'partner', 'file' => 'partner'],
			['folder' => 'slider', 'file' => 'slider'],
			['folder' => 'card-area', 'file' => 'overview-card'],
			['folder' => 'pricing', 'file' => 'pricing'],
			['folder' => 'counter', 'file' => 'counter'],
			['folder' => 'call-to-action', 'file' => 'call-to-action'],
			['folder' => 'text-brief', 'file' => 'text-brief'],
			['folder' => 'newsletter', 'file' => 'newsletter'],
			['folder' => 'testimonial', 'file' => 'testimonial'],
			['folder' => 'publisher', 'file' => 'publisher'],
			...
			['folder' => 'contact-info', 'file' => 'contact-card'],
			['folder' => 'product', 'file' => 'product'],
			['folder' => 'game', 'file' => 'game'],
			['folder' => 'site-offcanvas', 'file' => 'site-offcanvas'],
			['folder' => 'service', 'file' => 'service'],
			['folder' => 'list', 'file' => 'list'],
			['folder' => 'blockquote', 'file' => 'blockquote'],
