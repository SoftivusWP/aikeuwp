<?php
/**
 * Plugin Name: SV Header Footer Builder
...
define( 'BOOSTIFY_HEADER_FOOTER_VER', '1.3.2' );
...
function appsero_init_tracker_boostify_header_footer_builder() {
	...
	$client = new Appsero\Client( '745cf48e-22cd-49a0-abb5-3f225d08b708', 'SV Header Footer Builder for Elementor', __FILE__ );
