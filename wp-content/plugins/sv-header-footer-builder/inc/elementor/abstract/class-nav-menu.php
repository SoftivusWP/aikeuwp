...
abstract class Nav_Menu extends Widget_Base {
	...
	protected function mobile_menu() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'border',
                'selector' => '{{WRAPPER}} .boostify-menu-sidebar .boostify-dropdown-menu li:not( :last-child ) a',
            ]
        );
	...
	protected function submenu_style() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .boostify-menu .sub-menu-default li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .boostify-nav-default .sub-menu li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	...
	public function submenu_style_hover() {
		$this->add_control(
			...
			array(
				...
				'separator' => 'before',
				'selectors' => array(
					'{{WRAPPER}} .boostify-nav-default li .sub-menu > li:hover > a'                                  => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-nav-default .sub-menu li.current-menu-ancestor > a'                                       => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-nav-default .sub-menu li.current-menu-item > a'                                       => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-menu li .sub-menu-default > li:hover > a'                                  => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-menu li.current-menu-ancestor > a'                                       => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-menu .sub-menu-default li.current-menu-item > a'                                       => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-menu-sidebar .boostify-dropdown-menu li.current-menu-ancestor > a'                                       => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .boostify-menu-sidebar .boostify-dropdown-menu li.current-menu-item > a'                                       => 'color: {{VALUE}} !important',
				),
			)
		);
	...
	public function menu_sidebar_style_nornal() {
		...
		$this->add_control(
			'menu_sidebar_padding',
			array(
				'label'      => __( 'Sidebar Menu Padding', 'boostify' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .boostify-menu-sidebar .boostify-dropdown-menu a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				),
			)
		);
		...
		$this->add_control(
			'menu_a_padding',
			array(
				'label'      => __( 'Mobile Menu Padding', 'boostify' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} #menu-footer-menu li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				),
			)
		);
