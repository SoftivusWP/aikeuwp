<?php
    ...
    $author_info = get_the_author_meta( 'aikeu_write_by');
    $facebook_url = get_the_author_meta( 'aikeu_facebook' );
    $twitter_url = get_the_author_meta( 'aikeu_twitter' );
    $linkedin_url = get_the_author_meta( 'aikeu_linkedin' );
    $instagram_url = get_the_author_meta( 'aikeu_instagram' );
    $aikeu_url = get_the_author_meta( 'aikeu_youtube' );
    $aikeu_write_by = get_the_author_meta( 'aikeu_write_by' );
