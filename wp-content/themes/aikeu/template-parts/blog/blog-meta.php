...
$aikeu_blog_date = get_theme_mod( 'aikeu_blog_date', true );
$aikeu_blog_comments = get_theme_mod( 'aikeu_blog_comments', true );
$aikeu_blog_author = get_theme_mod( 'aikeu_blog_author', true );
$aikeu_blog_cat = get_theme_mod( 'aikeu_blog_cat', false );

?>


<div class="postbox__meta">
    <?php if ( !empty($aikeu_blog_author) ): ?>
