...
jQuery(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    function masonryCategory() {
      if ($(".category-masonry-1").length) {
        var $grid1 = $(".category-masonry-1").isotope({
          layoutMode: "fitRows",
          itemSelector: ".category-item",
        });

        $(".category-filter-1").on("click", "button", function () {
          var filterValue = $(this).attr("data-filter");
          $grid1.isotope({ filter: filterValue });
        });

        $(".category-filter-1").each(function (i, buttonGroup) {
          var $buttonGroup = $(buttonGroup);
          $buttonGroup.on("click", "button", function () {
            $buttonGroup.find(".active").removeClass("active");
            $(this).addClass("active");
      ...
      if ($(".category-masonry-2").length) {
        var $grid2 = $(".category-masonry-2").isotope({
          layoutMode: "fitRows",
          itemSelector: ".category-item",
        });

        $(".category-filter-2").on("click", "button", function () {
          var filterValue = $(this).attr("data-filter");
          $grid2.isotope({ filter: filterValue });
        });

        $(".category-filter-2").each(function (i, buttonGroup) {
          var $buttonGroup = $(buttonGroup);
          $buttonGroup.on("click", "button", function () {
            $buttonGroup.find(".active").removeClass("active");
            $(this).addClass("active");
     ...
     * ======================================
     */
    if (document.querySelector(".video-btn,.video-popup") !== null) {
      $(".video-btn,.video-popup").magnificPopup({
        disableOn: 768,
        type: "iframe",
        mainClass: "mfp-fade",
        removalDelay: 160,
